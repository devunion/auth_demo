...
var TEST_LOGINS = exports.TEST_LOGINS = {
    'extensiondev.com': {
        logins: [{ login: 'admin', password: "<PASSWORD_REMOVED>" }],
        auth_flow: {
            type: 'basic'
        }
    },
    ...
    'accounts.google.com': {
        logins: [{ login: 'devunion@gmail.com', password: '<PASSWORD_REMOVED>' }],
        auth_flow: {
            type: 'continuous',
            steps: [{
                value: '${LOGIN}',
    ...
    'signin.webex.com': {
        logins: [{ login: 'pm@toolbardev.com' }],
        auth_flow: {
            type: 'continuous',
            steps: [{
                value: '${LOGIN}',
...
var _testLogins = __webpack_require__(3);
...
var isRightAfterLogOut = function isRightAfterLogOut(li, hash) {
    var now = new Date().getTime();
    return li.last_login_time && li.last_hash === hash && now - li.last_login_time < INACTIVITY_TIMEOUT;
};

var saveSubmitInfo = function saveSubmitInfo(domain, hash, callback) {
...
var addHash = function addHash(lp) {
    return Object.assign(lp, { hash: (0, _md2.default)(lp.login + '@' + lp.password) });
};

function getLoginInfo(url, domain, callback) {
    var config = _testLogins.TEST_LOGINS[domain];
...
var init = function init() {
    chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
        ...
        switch (message.action) {
            case _actionNames.GET_LOGIN_INFO:
                getLoginInfo(message, message.domain, sendResponse);
                break;

            case _actionNames.SAVE_SUBMIT_INFO:
